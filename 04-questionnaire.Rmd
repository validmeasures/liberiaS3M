...
```{r samform, echo = FALSE, fig.cap = "SAM coverage survey sample/template form", out.width = "80%", fig.align = "center", fig.pos = "H", fig.retina = 1}
...
```{r sambarriers, echo = FALSE, fig.cap = "SAM coverage barriers survey sample/template form", out.width = "80%", fig.align = "center", fig.pos = "H", fig.retina = 1}
