...
To determine how many villages near the 30 sampling points to select for the stage 1 sample, it would require estimating how many villages will need to be sampled to obtain the target sample size of 96 SAM children in each county (and urban areas if included). This can be estimated as follows:
