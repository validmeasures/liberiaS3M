...
{\centering \includegraphics{liberiaS3M_files/figure-latex/smallScaleMap-1} 
...
{\centering \includegraphics{liberiaS3M_files/figure-latex/smallScaleMapCounty-1} 
...
{\centering \includegraphics{liberiaS3M_files/figure-latex/largeScaleMapCounty-1} 
...
{\centering \includegraphics{liberiaS3M_files/figure-latex/largeScaleMapDistricts-1} 
...
{\centering \includegraphics{liberiaS3M_files/figure-latex/grid1-1} 
...
{\centering \includegraphics{liberiaS3M_files/figure-latex/grid2-1} 
...
\caption{Selecting alternating intersections of the grid in the x and y directions to spread sampling points evenly}\label{fig:grid2a}
\end{figure}
...
{\centering \includegraphics{liberiaS3M_files/figure-latex/grid3-1} 
...
{\centering \includegraphics{liberiaS3M_files/figure-latex/grid3a-1} 

}

\caption{Montserrado county with a rectangular grid defined by d of 6 km and sampling points moved to the nearest communities}\label{fig:grid3a}
\end{figure}
...
{\centering \includegraphics{liberiaS3M_files/figure-latex/grid3c-1} 

}

\caption{Montserrado county with a rectangular grid defined by d of 6 km and sampling points moved to the nearest communities}\label{fig:grid3c}
\end{figure}
