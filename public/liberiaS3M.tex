...
\caption{Small scale map of Liberia showing counties and settlements}\label{fig:smallScaleMap}
\end{figure}
...
\hypertarget{liberias3m}{%
\chapter{liberiaS3M}\label{liberias3m}}

The goal of liberiaS3M is to \ldots{}
