...
montserradoBox <- create_buffer(x = montserradoBox, buffer = 4, country = "Liberia")

x <- seq(from = extent(montserradoBox)[1], to = extent(montserradoBox)[2], by = 18000)

y <- seq(from = extent(montserradoBox)[3], to = extent(montserradoBox)[4], by = 10392.3)
